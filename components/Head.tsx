...
export const Head: FC<Props> = ({
  ogImage = 'https://freshdrops.io/img/freshdrops-logo-beta.svg',
  title = 'Freshdrops | NFT Marketplace Aggregator',
  description = 'Freshdrops - the original and still fastest and most accurate fast rarity tool.',
}) => {
  return (
    <NextHead>
      ...
      <meta name="twitter:site" content="@freshdrops_io" />
      ...
      <meta property="og:image:alt" content="Freshdrops Icon" />
    </NextHead>
  )
}
